...
func TestCdim11(t *testing.T) {
	g := NewGuitarWithStandardTuning()
	chord, err := NewChord("Cdim11")
	require.NoError(t, err)
	err = g.drawChord(guitar_dim11_0_ChordShape, chord, os.Stdout)
	require.NoError(t, err)
}

func TestCdim9(t *testing.T) {
	g := NewGuitarWithStandardTuning()
	chord, err := NewChord("Cdim9")
	require.NoError(t, err)
	err = g.drawChord(guitar_dim9_0_ChordShape, chord, os.Stdout)
	require.NoError(t, err)
}

func TestCdim(t *testing.T) {
	g := NewGuitarWithStandardTuning()
	chord, err := NewChord("Cdim")
	require.NoError(t, err)

	err = g.drawChord(guitar_dim_0_ChordShape, chord, os.Stdout)
	require.NoError(t, err)

	err = g.drawChord(guitar_dim_1_ChordShape, chord, os.Stdout)
	require.NoError(t, err)
}

func TestCaug6(t *testing.T) {
	g := NewGuitarWithStandardTuning()
	chord, err := NewChord("Caug6")
	require.NoError(t, err)

	err = g.drawChord(guitar_aug6_0_ChordShape, chord, os.Stdout)
	require.NoError(t, err)
}
...
func TestCaug11(t *testing.T) {
	g := NewGuitarWithStandardTuning()
	chord, err := NewChord("Caug11")
	require.NoError(t, err)

	err = g.drawChord(guitar_aug11_0_ChordShape, chord, os.Stdout)
	require.NoError(t, err)
}

func TestCm7Sharp5(t *testing.T) {
	g := NewGuitarWithStandardTuning()
	chord, err := NewChord("Cm7#5")
	require.NoError(t, err)

	err = g.drawChord(guitar_m7_sharp_5_0_ChordShape, chord, os.Stdout)
	require.NoError(t, err)
}

func TestCmaj7Sharp11(t *testing.T) {
	g := NewGuitarWithStandardTuning()
	chord, err := NewChord("Cmaj7#11")
	require.NoError(t, err)

	err = g.drawChord(guitar_maj7_sharp_11_0_ChordShape, chord, os.Stdout)
	require.NoError(t, err)
}
