...
// C major (C E G) — root on string 1 (index 0)
var (
...
// A major (A C# E) — root on string 1 (index 0)
var (
...
// A minor (A C E) — root on string 1 (index 0)
var (
...
// G major (G B D) — root on string 2 (index 2)
var (
...
// G minor (G Bb D) — root on string 2 (index 2)
var (
...
// D major (D F# A) — root on string 2 (index 2)
var (
...
// D minor (D F A) — root on string 2 (index 2)
var (
...
// E minor (E G B) — root on string 1 (index 0)
var (
...
// F major (F A C) — root on string 2 (index 2)
var (
