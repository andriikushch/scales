...
var (
	guitar_7_sharp_9_0_Schema     = []int{}
	guitar_7_sharp_9_0_ChordShape = newChordShape("guitar", []int{0, 4, 7, 10, 15}, guitar_7_sharp_9_0_Schema, -1)
)
