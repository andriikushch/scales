...
var (
	mandolin_7_0_Schema     = []int{0, 0, 5, 6}
	mandolin_7_0_ChordShape = newChordShape("mandolin", []int{0, 4, 7, 10}, mandolin_7_0_Schema, 1)
)

var (
	mandolin_7_1_Schema     = []int{2, 2, 1, 2}
	mandolin_7_1_ChordShape = newChordShape("mandolin", []int{0, 4, 7, 10}, mandolin_7_1_Schema, 1)
)

var (
	mandolin_7_2_Schema     = []int{1, 2, 0, 0}
	mandolin_7_2_ChordShape = newChordShape("mandolin", []int{0, 4, 7, 10}, mandolin_7_2_Schema, 3)
)

var (
	mandolin_7_3_Schema     = []int{2, 3, 0, 2}
	mandolin_7_3_ChordShape = newChordShape("mandolin", []int{0, 4, 7, 10}, mandolin_7_3_Schema, 2)
)

var (
	mandolin_7_4_Schema     = []int{0, 2, 0, 1}
	mandolin_7_4_ChordShape = newChordShape("mandolin", []int{0, 4, 7, 10}, mandolin_7_4_Schema, 0)
)

var (
	mandolin_7_5_Schema     = []int{0, 2, 0, 1}
	mandolin_7_5_ChordShape = newChordShape("mandolin", []int{0, 4, 7, 10}, mandolin_7_5_Schema, 0)
)
